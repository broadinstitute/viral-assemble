...
class TestKmc(TestCaseWithTmp):
    ...
    def test_simple_kmer_extraction(self):
        with util.file.tmp_dir(suffix='kmctest') as t_dir:
            ...
            util.cmd.run_cmd(kmers, 'build_kmer_db', [simple_fasta, kmc_db, '-k', 4])
            ...
            util.cmd.run_cmd(kmers, 'dump_kmers', [kmc_db, kmers_fasta])
    ...
    def test_read_filtering(self):
        with util.file.tmp_dir(suffix='kmctest') as t_dir:
            ...
            util.cmd.run_cmd(kmers, 'filter_by_kmers', [kmc_db, filt_fasta, filt_fasta_out, '--readMinOccs', 1])
